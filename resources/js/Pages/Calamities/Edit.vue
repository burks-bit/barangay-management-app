    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-4xl mx-auto space-y-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Edit Calamity</h1>
                    <p class="text-sm text-gray-500">Update calamity event</p>
                </div>
            ...
            <form @submit.prevent="submit" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-2">
                        ...
                        <input v-model="form.event_code" type="text" class="w-full px-3 py-2 rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required />
                    ...
                    <div>
                        ...
                        <input v-model="form.started_at" type="datetime-local" class="w-full px-3 py-2 rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" />
                    </div>
                    <div>
