    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-4xl mx-auto space-y-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Edit {{ center.name }}</h1>
                    <p class="text-sm text-gray-500">Update evacuation center details</p>
                </div>
            ...
            <form @submit.prevent="submit" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
                ...
                <div class="flex items-center justify-end space-x-3 pt-4 border-gray-100 border-t">
